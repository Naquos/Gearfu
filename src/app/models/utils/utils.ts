...
export const mapSortAction = new Map<IdActionsEnum, number>([
    ...
    [IdActionsEnum.ARMURE_DONNEE, 36],
    [IdActionsEnum.ARMURE_RECUE, 37],
    [IdActionsEnum.PERTE_COUP_CRITIQUE, 38],
    [IdActionsEnum.PERTE_ARMURE_DONNEE_RECUE, 39],
    [IdActionsEnum.RESISTANCES_CRITIQUES, 40],
    [IdActionsEnum.RESISTANCES_DOS, 41],
    [IdActionsEnum.RESISTANCES_ELEMENTAIRE, 42],
    [IdActionsEnum.RESISTANCES_NOMBRE_VARIABLE, 43],
    [IdActionsEnum.RESISTANCES_FEU, 44],
    [IdActionsEnum.RESISTANCES_EAU, 45],
    [IdActionsEnum.RESISTANCES_AIR, 46],
    [IdActionsEnum.RESISTANCES_TERRE, 47],
    [IdActionsEnum.PERTE_RESISTANCES_CRITIQUE, 48],
    [IdActionsEnum.PERTE_RESISTANCES_DOS, 49],
    [IdActionsEnum.PERTE_RESISTANCES_ELEMENTAIRE, 50],
    [IdActionsEnum.PERTE_RESISTANCES_FEU, 51],
    [IdActionsEnum.PERTE_RESISTANCE_EAU, 52],
    [IdActionsEnum.PERTE_RESISTANCES_TERRE, 53],
    [IdActionsEnum.MAITRISE_PAR_LEVEL, 54],
    [IdActionsEnum.APPLIQUE_ETAT, 55],
]);
