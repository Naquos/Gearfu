...
export class SaveBuildService {
    ...
    public createAndNavigate(): void {
        this.supabaseService.createEmptyBuild().subscribe(newBuild => {
            ...
            this.localStorageService.setItem<string>(KeyEnum.KEY_BUILD_ID, newBuild.id);
            this.localStorageService.setItem<string>(KeyEnum.KEY_TOKEN_BUILD_CURRENT, this.localStorageService.getItem<string>(KeyEnum.KEY_TOKEN) || '');
    ...
    public listenBuildChanges(): void {
        combineLatest([
            ...
            tap(() => {
                const token_build = this.localStorageService.getItem<string>(KeyEnum.KEY_TOKEN_BUILD_CURRENT);
    ...
    private saveBuildToSupabase(): void {
        const build: Build = {
            id: this.localStorageService.getItem<string>(KeyEnum.KEY_BUILD_ID) || '',
    ...
    private getNameFromBuild(): string {
        const id = this.localStorageService.getItem<string>(KeyEnum.KEY_BUILD_ID) || '';
    ...
    public loadBuild(build: Build): void {
        ...
        this.localStorageService.setItem<string>(KeyEnum.KEY_BUILD_ID, build.id ?? "");
        this.localStorageService.setItem<string>(KeyEnum.KEY_TOKEN_BUILD_CURRENT, build.token || 
            this.localStorageService.getItem<string>(KeyEnum.KEY_TOKEN) || ''
        );
    }
