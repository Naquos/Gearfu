...
export class ObtentionFormService extends AbstractFormService<FormGroup<TypedControls<ObtentionForm>>> {
  ...
  public setDefaultValue(): void {
    this.setValue({ DROP: ObtentionFormService.DEFAULT_VALUE_DROP, CRAFTABLE: ObtentionFormService.DEFAULT_VALUE_CRAFTABLE, BOSS: ObtentionFormService.DEFAULT_VALUE_BOSS, ARCHI: ObtentionFormService.DEFAULT_VALUE_ARCHI });
  }
