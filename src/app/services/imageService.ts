...
export class ImageService {
    ...
    private readonly mapUrlCharacteristics = new Map<IdActionsEnum, string>([
        ...
        [IdActionsEnum.MAITRISE_PAR_LEVEL, ImageService.BASE_URL_CHARACTERISTICS + "DMG_IN_PERCENT.png"],
    ...
    public getSublimationImageUrl(linkSublimation: LinkSublimation): string {
        let id = -1;
