...
const ALL_FALSE: MajorPresentForm = {
    PA: false, PM: false, PW: false, PO: false,
    ARMURE_DONNEE: false, ARMURE_RECUE: false,
    CRITIQUE: false, PARADE: false,
    RESISTANCE_DOS: false, RESISTANCE_CRITIQUE: false,
    TACLE: false, ESQUIVE: false,
    PERTE_PA: false, PERTE_PM: false, PERTE_PW: false, PERTE_PO: false,
    PERTE_ARMURE_DONNEE: false, PERTE_ARMURE_RECUE: false,
    PERTE_CRITIQUE: false, PERTE_PARADE: false,
    PERTE_RESISTANCE_DOS: false, PERTE_RESISTANCE_CRITIQUE: false,
    PERTE_MAITRISES_MELEE: false, PERTE_MAITRISES_DISTANCE: false,
    PERTE_MAITRISES_CRITIQUE: false, PERTE_MAITRISES_DOS: false,
    PERTE_MAITRISES_SOIN: false, PERTE_MAITRISES_BERZERK: false,
    PERTE_TACLE: false, PERTE_ESQUIVE: false,
};

@Injectable({ providedIn: 'root' })
export class MajorPresentFormService extends AbstractSignalFormService<MajorPresentForm> {
