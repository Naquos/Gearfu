...
Para alvos que terminam seu turno em seu contato: Flutua\xE7\xE3o (+20 Niv.)`},effect_critical:{fr:"",en:"",es:"",pt:""}},{gfxId:4956,name:{fr:"Inspiration",en:"Inspiration",es:"Inspiraci\xF3n",pt:"Inspira\xE7\xE3o"},description:{fr:"Une bonne respiration, une boisson fra\xEEche et on entame le combat !",en:"A good breath, a cool drink and we start the fight!",es:"\xA1Una buena respiraci\xF3n, una bebida fresca y comenzamos la pelea!",pt:"Uma boa respira\xE7\xE3o, uma bebida fresca e come\xE7amos a luta!"},urls:{fr:"",en:"",es:"",pt:""},PA:0,PW:0,PM:0,NotLDV:!1,POModifiable:!1,Ligne:!1,PorteeMin:0,PorteeMax:0,effect_normal:{fr:`50% du niveau en Initiative
...
Cura de \xE1gua: 33 ao redor do Osso da Medula na \xE1rea 1-1`},effect_critical:{fr:"",en:"",es:"",pt:""}}];var h=class n{http=s(f);classeFormService=s(p);sorts=new l([]);sorts$=this.sorts.asObservable();sortsClasse=m(d([this.sorts$,this.classeFormService.classe$]).pipe(t(([e,a])=>e.filter(P=>P.idClasse===a)[0]),t(e=>e?i(r({},e),{sortActifs:[...e.sortActifs],sortPassifs:[...e.sortPassifs],sortElementaires:{feu:[...e.sortElementaires.feu],eau:[...e.sortElementaires.eau],air:[...e.sortElementaires.air],terre:[...e.sortElementaires.terre]}}):void 0),o(e=>e?.sortActifs.push(...g)),o(e=>e?.sortPassifs.push(...v))),{initialValue:void 0});loadPromise;load(){return this.loadPromise?this.loadPromise:(this.loadPromise=new Promise(e=>{this.http.get("/sorts.json").pipe(o(a=>this.sorts.next(a)),u(1)).subscribe({next:()=>e(),error:a=>{console.error("Failed to load monster drops:",a),this.sorts.next([]),e()}})}),this.loadPromise)}getDescriptionSortElementaireById(e){return this.sortsClasse()?.sortElementaires.feu.find(a=>a.gfxId===e)||this.sortsClasse()?.sortElementaires.eau.find(a=>a.gfxId===e)||this.sortsClasse()?.sortElementaires.air.find(a=>a.gfxId===e)||this.sortsClasse()?.sortElementaires.terre.find(a=>a.gfxId===e)}getDescriptionSortPassifById(e){return this.sortsClasse()?.sortPassifs.find(a=>a.gfxId===e)}getDescriptionSortActifById(e){return this.sortsClasse()?.sortActifs.find(a=>a.gfxId===e)}static \u0275fac=function(a){return new(a||n)};static \u0275prov=c({token:n,factory:n.\u0275fac,providedIn:"root"})};export{h as a};
